                                ...
                                <div class="detail-info pr-30 pl-30">
                                    ...
                                    <div class="short-desc mb-30">
                                        ...
                                        @else
                                            <div class="attr-detail attr-size mb-30">
                                                <strong class="mr-10" style="width:30px;">Size:</strong>
                                        ...
                                        @else
                                            <div class="attr-detail attr-size mb-30">
                                                <strong class="mr-10" style="width:30px;">Color:</strong>
                                                <select class="form-control unicase-form-control" id="size">
                                                    <option selected="" disabled="">--Choose Size--</option>
                                    ...
                                    <div class="font-xs">
                                        ...
                                        <ul class="float-start">
                                            ...
                                            <li class="mb-5">Tags: <a href="#" rel="tag">{{$product->product_tags}}</a>, <a href="#" rel="tag">Organic</a>, <a href="#" rel="tag">Brown</a></li>
