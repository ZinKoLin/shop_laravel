        ...
        <div class="container">
            <div class="archive-header">
                <div class="row align-items-center">
                    <div class="col-xl-3">
                        <h1 class="mb-15">{{$subbreadcat->subcategory_name}}</h1>
                        <div class="breadcrumb">
                            <a href="index.html" rel="nofollow"><i class="fi-rs-home mr-5"></i>Home</a>
                            <span></span>{{$subbreadcat->subcategory_name}}<span></span>
                            {{$subbreadcat->category->category_name}}
                        </div>
                    </div>
                            ...
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                ...
                                <div class="product-content-wrap">
                                    <div class="product-category">
                                        <a href="{{url('product/subcategory'.'/'.$subbreadcat->id.'/'.$subbreadcat->subcategory_slug)}}">{{ $product['subcategory']['subcategory_name'] }}</a>
                                    </div>
