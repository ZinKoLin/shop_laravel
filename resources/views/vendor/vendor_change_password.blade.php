                            ...
                            <form method="post" action="{{route('#vendor.update.password')}}" >
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="new_password_confirmation" class="form-control @error('new_password_confirmation') is-invalid @enderror"
                                                   id="new_password_confirmation"  placeholder="conirm new password" />
